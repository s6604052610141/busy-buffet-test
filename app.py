...
with tab1:
    ...
    st.write("**อาจจะไม่ได้ผล:** การลดเวลาลงมากเกินไปแบบเหมารวม จะกระทบต่อประสบการณ์ของแขก In-house ที่ต้องการพักผ่อน จากข้อมูลพบว่าแขก In-house บางกลุ่มใช้เวลานานสูงสุดถึง 321 นาที การตั้งกฎที่ตึงเกินไปอาจสร้างความไม่พอใจให้ลูกค้าระดับ VIP ของโรงแรมได้")
...
1. **ครอบคลุมลูกค้าส่วนใหญ่:** ข้อมูลชี้ชัดว่าลูกค้า Walk-in นั่งทานเฉลี่ย 72.78 นาที และ In-house นั่งเฉลี่ยเพียง 45.81 นาที การจำกัดเวลาไว้ที่ 120 นาที (2 ชั่วโมง) จึงครอบคลุมและเพียงพอสำหรับลูกค้ากว่า 90%
